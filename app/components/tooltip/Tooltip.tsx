...
const Tooltip = ({
  ...
  const classMap: Record<TooltipDirection, string> = {
    top: "absolute w-[260px] z-[999] hidden text-center shadow-lg group-hover:block bg-[#333] text-white font-semibold px-3 py-[6px] text-[12px] left-[-270px] mx-auto top-[-50px] rounded",
    bottom:
