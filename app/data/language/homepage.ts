export const homepageMap: Record<string, Record<string, string>> = {
  ...
  sr: {
    ...
    heroSubtitle: "Realvest vas povezuje sa relevantnim tržišnim podacima koji olakšavaju proces donošenja odluka pri kupovini, prodaji ili izdavanju nekretnina.",
    heroCta: "Napravite nalog besplatno",
    howTitle: "Potpuno besplatno u samo 3 klika saznajte stanje na tržištu.",
    howTime: "Izaberite vremenski period koji treba uzeti u obzir prilikom generisanja izveštaja.",
    ...
    benefitFinancialText: "Prikazujemo podatke koji vam mogu ukazati da li bi nekretnina u određenoj zoni, sa određenim karakteristikama bila dobra investicija ili kupovina. Primarna informacija koju pratimo je kretanje prodajne cene nekretnina kroz vreme. Takodje, pratimo i potencijal nekretnine da generiše prihod kroz izdavanje.",
    benefitData: "Brze i jasne informacije",
    benefitDataText: "Generišemo grafikone, tabele i izveštaje koji pokazuju kretanje cena nekretnina, cena kvadrata, postojanja određenih odlika u označenoj zoni. Svaka vizualizacija se sastoji iz konkretnih informacija koje su relevantne za ono što vi tražite. Takođe, podaci se kontinuirano obrađuju sa ciljem obezbeđivanje još relevantnijih i korisnijih informacija.",
    faq: "Često postavljana pitanja:",
    faq1Title: "Za koje gradove postoje dostupni podaci?",
    faq1Text: "Trenutno prikupljamo i obradjujemo podatke isključivo za Beograd. To je najveće i najdinamičnije tržište, zbog toga je odabrano kao početno. U planu je proširenje i na druge veće gradove u Srbiji. Svi naši korisnici biće o tome blagovremeno obavešteni.",
    faq2Title: "Odakle dolaze podaci koje koristite?",
    faq2Text: "Naši glavni izvori podataka su Registar cena nepokretnosti RGZ-a i internet portali za oglašavanje nekretnina. Aktivno tražimo nove izvore podataka kako bismo uspeli da ponudimo najrelevantnije i najkorisnije podatke sa tržišta.",
    faq3Title: "Da li je nalog zaista besplatan?",
    faq3Text: "Da, nalog je u potpunosti besplatan. Prilikom kreiranja potrebno je samo da upišete ime, validan email i lozinku, ili da se registrujete preko vašeg Google naloga.",
    faq4Title: "Koliko često se ažuriraju podaci?",
    faq4Text: "Ažuriranje podataka zavisi od promena na tržištu i dostupnosti podataka iz izvorima koje koristimo. Na primer, podaci o prodaji ažuriraju se na mesečnom nivou zbog toga što prate podatke iz Registra cena nepokretnosti RGZ-a. Neke druge promene na tržištu, poput trenutne ponude, prikazujemo i ažuriramo odmah.",
    ...
    faq6Text: "Podaci koje trenutno prikupljamo podeljeni su na 3 vrste nekretnina: rezidencijalni (stanovi), komercijalni (poslovni prostori) i garažni. Podaci za sve 3 vrste dostupni su za sve korisnike.",
    ...
    errorPageSubTitle: "Vaš poslednji zahtev je prouzrokovao trenutnu grešku. Pokušajte da osvežite stranicu ili kliknite na dugme ispod da biste se vratili na počtnu stranicu.",
