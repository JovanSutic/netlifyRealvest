export const homepageMap: Record<string, Record<string, string>> = {
  en: {
    ...
    latestSub:
      "Bonds backed by rentable real estate are a great way for small, conservative investors to invest their money at a lower level of risk.",
    ...
    howOption1: "Browse",
    howOption1Sub:
      "Create an account on our platform and discover all the investment opportunities available to you.",
    howOption2: "Invest",
    howOption2Sub:
      "Read the full prospectus of the offer, include your risks, and start building your portfolio.",
    howOption3: "Earn",
    howOption3Sub:
      "Receive a fixed annual interest and expect a premium if the property appreciates until maturity date.",
    ...
    faq1Text:
      "Every bond has predefined fixed annual interest which depends on its underlying property. You can also expect to get a premium if the value of your bond's underlying property grows in market value by the end of the bond maturity period.",
    ...
    faq3Text:
      "User account on the Realvest platform is free. All users can see currently offered bonds and its underlying properties. Also users have access to secondary bond market. Those users that have bought the bonds (investors) will see their investment portfolio.",
    faq4Title:
      "Why should I buy Realvest bonds when I can keep my money in the savings account?",
    faq4Text:
      "You are free to invest your money as you see fit. We are striving to find properties that can give our investors very good annual interest and solid appreciation with minimal risk. Data shows that current savings account annual interest rates do not pass 2.55%. Our goal is to provide our investors with at least the same annual interest rate plus the possibility to profit from the property value growth in the maturity period.",
    faq5Title: "What are the obligations of the investors?",
    faq5Text:
      "Before you decide to invest in Realvest bonds you need to inform yourself about our service and our offer, a great start is our Knowledge Base. After info gathering and browsing of our offering, potential investors have to become users and provide certain personal information and consents needed for the successful bond purchase. There can be additional info required in the situation of the internal or government regulation change.",
  ...
  sr: {
    ...
    howOption1Sub:
      "Otvorite nalog na našoj web platformi i otkrijte sve dostupne investicione prilike.",
    ...
    howOption3Sub:
      "Dobijajte redovnu kamatu i očekujte premiju u slučaju da vrednost osnovne imovine vaše obveznice poraste u periodu dospeća.",
    ...
    faq1Text:
      "Svaka deonica ima predefinisani iznos fiksne godišnje kamate koji zavisi od osnovne imovine obveznice. Osim fiksne kamate možete očekivati premiju ukoliko po isteku obveznice vrednost nekretnine na koju se obveznica odnosi poraste.",
    faq2Title:
      "Da li moram da zadržim svoju obveznicu do njenog perioda dospeća?",
    faq2Text:
    ...
    faq4Text:
      "Slobodni ste da uložite svoj novac kako vam odgovara. Mi se trudimo da pronađemo nekretnine koje našim investitorima mogu dati veoma dobru godišnju kamatu i solidnu vrednost uz minimalan rizik. Podaci pokazuju da godišnje kamatne stope na štednim računima ne prelaze 2.55%. Naš cilj je da našim investitorima obezbedimo najmanje istu godišnju kamatnu stopu plus mogućnost da profitiraju od rasta vrednosti nekretnine u roku dospeća.",
    faq5Title: "Kakve su moje obaveze kao investitora?",
    faq5Text:
      "Pre nego što se odlučite da investirate u Realvest obveznice potrebno je da se dobro informišete u vezi sa našom uslugom, za početak pogledajte našu Bazu Znanja. Nakon prikupljanja potrebnih informacija i pregleda ponuđenih obveznica, potencijalni investitori moraju otvoriti korisnički nalog i dostaviti sve potrebne lične informacije i saglasnosti koje su potrebne za uspešnu kupovinu obveznice. Moguće su zahtevi za dodatnim informacijama ukoliko interna ili državna regulativa to bude nalagala.",
