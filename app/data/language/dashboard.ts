export const dashboardMap: Record<string, Record<string, string>> = {
  ...
  sr: {
    ...
    priceGrowth: "rase cene",
    forFive: "ZA 5 GODINA",
    forTen: "ZA 10 GODINA",
    currentPrice: "Trenutna prosečna cena kvadrata:",
    priceDiff: "Razlika u ceni po kvadratu:",
    ...
    years: "godina",
    bigAreaWarn: "Smanjite krug mikrolokacije na 250 ili 500 metara ukoliko želite da vidite podatke o isplativosti mikrolokacije.",
