export const componentsMap: Record<string, Record<string, string>> = {
  en: {
    ...
    planModalText1: "At this moment online payment is not yet activated. If you are interested in this plan please contact us through email.",
    ...
    planModalText5: ". We will be glad to send you our payment instruction. Thank you for your understanding.",
    planBasicText:
  ...
  sr: {
    ...
    planModalText1: "U ovom trenutku online plaćanje još uvek nije aktivirano. Ukoliko ste zainteresovani za ovaj plan molimo Vas da nas kontaktirate putem emaila.",
